# 🔍 تقرير تدقيق الصفحة الرئيسية - محترفين الديار العالمية
...
<Image 
  src="..." 
  alt="مظلات سيارات PVC في جدة - مشروع فيلا العليا - محترفين الديار العالمية"
/>
```
...
images: [{
  ...
  width: 1200,
  height: 630,
  alt: 'محترفين الديار العالمية - مظلات وسواتر جدة',
  type: 'image/webp',
}]
```
...
```typescript
// نمط موحد:
`${serviceType} ${material} في ${location} - ${projectName} - محترفين الديار العالمية`

// مثال:
"مظلات سيارات PVC في حي الروضة جدة - مشروع فيلا المهندس - محترفين الديار العالمية"
```
