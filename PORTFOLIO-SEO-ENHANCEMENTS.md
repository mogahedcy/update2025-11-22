...
function generateImageAlt(project, imageIndex) {
  ...
  const templates = {
    1: `${category} في ${location} - صورة رئيسية | محترفين الديار العالمية`,
...
// مثال:
// Alt 1: "مظلات سيارات في حي النعيم جدة - صورة رئيسية | محترفين الديار العالمية"
...
// العربية
{
  title: "مظلات سيارات حي النعيم جدة | محترفين الديار العالمية",
...
<meta property="product:brand" content="محترفين الديار العالمية" />
```
