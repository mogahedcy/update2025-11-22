...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isArabic 
      ? 'تواصل معنا | محترفين الديار العالمية - خدمة العملاء 24/7'
      : 'Contact Us | Aldeyar Global Professionals - 24/7 Customer Service',
    description: isArabic
      ? 'تواصل مع فريق محترفين الديار العالمية في جدة عبر الهاتف أو واتساب. خدمة عملاء متميزة 24/7، استشارة مجانية فورية.'
    ...
    openGraph: {
      title: isArabic ? 'تواصل معنا | محترفين الديار العالمية' : 'Contact Us | Aldeyar Global Professionals',
      description: isArabic 
        ? 'تواصل مع فريق محترفين الديار العالمية في جدة. خدمة عملاء متميزة 24/7.'
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: isArabic ? 'تواصل معنا - محترفين الديار العالمية' : 'Contact Us - Aldeyar Global Professionals',
        },
      ],
    },
    twitter: {
