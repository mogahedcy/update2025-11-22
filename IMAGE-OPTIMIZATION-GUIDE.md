...
// النتيجة: "مظلات سيارات PVC في حي الروضة جدة - مشروع فيلا المهندس أحمد | محترفين الديار العالمية"

// 2. Alt text للخدمات
generateServiceAltText('مظلات سيارات', 'جدة');
// النتيجة: "مظلات سيارات في جدة، السعودية - تركيب احترافي بضمان 10 سنوات | محترفين الديار العالمية"

// 3. Alt text للمشاريع
generateProjectAltText('فيلا العليا', 'مظلات سيارات', 'جدة', 0);
// النتيجة: "مظلات سيارات في جدة، السعودية - فيلا العليا - صورة 1 | محترفين الديار العالمية"

// 4. Alt text لصور Hero
generateHeroAltText('مظلات وبرجولات حدائق فاخرة');
// النتيجة: "مظلات وبرجولات حدائق فاخرة - محترفين الديار العالمية | أفضل شركة مظلات وسواتر في جدة"
...
1. **صور المشاريع**:
   ```
   "مظلات سيارات PVC في حي الروضة جدة - مشروع فيلا المهندس أحمد - صورة 1 | محترفين الديار العالمية"
   ```

2. **صور الخدمات**:
   ```
   "برجولات خشبية للحدائق في جدة، السعودية - تركيب احترافي بضمان 10 سنوات | محترفين الديار العالمية"
   ```

3. **صور Hero**:
   ```
   "مظلات وبرجولات حدائق فاخرة - تركيب برجولات خشبية ومظلات سيارات جدة | محترفين الديار العالمية"
   ```
